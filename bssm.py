...
CONFIDENCELIVE = 0.1 # Confidence for infernce on live vid feed to detect shot; value ranges from 0 to 1.0
CONFIDENCEPROCESS = 0.1 # Confidence for infernce on cropped shots to be processed into data; value ranges from 0 to 1.0
